...
class Addresses(models.Model):
    ...
    society_name = models.CharField(max_length=255, blank=True)
    area = models.CharField(max_length=255)
    landmark  = models.CharField(max_length=255, blank=True)
    google_location_url = models.URLField(max_length=255, blank=True)
...
class CakeOrderHistory(models.Model):
    ...
    razorpay_signature = models.CharField(max_length=200, default="default_razorpay_signature")
    status = models.CharField(max_length=255)
